                                    ...
                                    <td>
                                        <form action="{{ route('users.destroy',$user->id) }}" method="POST">
                                            ...
                                            switch ($user->rol_id) {
                                                case '2':
                                                    //Docente
                                                    echo '<a onclick="setSubjectUser(2,' . $user->id . ')" class="btn btn-warning btn-sm"> Asignar Materia </a>';
                                                    break;
                                                case '3':
                                                    //Estudiante
                                                    echo '<a onclick="setSubjectUser(3,' . $user->id . ')" class="btn btn-warning btn-sm"> Asignar Materia </a>';
                                                    break;
                                            }
                                            ?>
